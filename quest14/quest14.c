...
int main()
{
    ...
    case(0):
        ...
        exec_code1 = execlp("gcc","gcc","-c","test.c","sqr.c","sum.c",NULL);
        if(exec_code1<1)
        {
            perror("execlp");
            exit(2);
    ...
    case(0):
        ...
        exec_code2 = execlp("ar","ar","rc","libfunc.a","sqr.o","sum.o",NULL);
        if(exec_code2<1)
        {
            perror("execlp");
            exit(2);
    ...
    case(-1):
        ...
        exit(1);
    case(0):
        exec_code3 = execlp("gcc","gcc","-L.","test.o","-o","libout.out","-lfunc",NULL);
        if(exec_code3<1)
        {
            perror("execlp");
            exit(2);
